...
| `navi.log.warn(msg)`  | <font color="#ffff00">Yellow | Non-fatal problems, missin</font>g optional config |
| `navi.log.error(msg)` | <font color="#ff0000">Red                          | F</font>ailures that affect functionality                 |
